export const users = [
  {
    uid: "bob-id",
    displayName: "Bob Cartwright",
    email: "bob.cartwright@pegasus.com",
    photoURL: "https://randomuser.me/api/portraits/men/1.jpg"
  },
  {
    uid: "tom-id",
    displayName: "Tom Hughes",
    email: "tom.hughes@griffin.com",
    photoURL: "https://randomuser.me/api/portraits/men/3.jpg"
  },
  {
    uid: "jane-id",
    displayName: "Jane Wilkes",
    email: "jane.wilkes@unicorn.com",
    photoURL: "https://randomuser.me/api/portraits/women/8.jpg"
  },
  {
    uid: "raj-id",
    displayName: "Raj Singh",
    email: "raj.singh@drogon.com",
  ...
  {
    uid: "nigel-id",
    displayName: "Nigel Brookes",
    email: "nigel.brookes@neptune.com",
